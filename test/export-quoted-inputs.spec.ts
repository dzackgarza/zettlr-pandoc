...
describe('Quote-bearing export inputs (review B2/B11)', function () {
  ...
  it('delivers apostrophe-bearing filenames and titles as exact single tokens', async function () {
    ...
    await copyFile(path.join(FIXTURE_ROOT, 'ProjectA', 'Halphen_Surfaces.md'), path.join(projectDir, "Halphen's Pencils.md"))
    await copyFile(path.join(FIXTURE_ROOT, 'ProjectA', 'Coble_Lattice_Table.md'), path.join(projectDir, 'Coble_Lattice_Table.md'))
