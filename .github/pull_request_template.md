...
## Repository alignment — required

- [ ] Read the repository `AGENTS.md` instructions.
- [ ] The change has no fallback, swallowed error, or partial-success path.
- [ ] Optional state uses an explicit typed boundary.
