...
A fork of [Zettlr](https://github.com/Zettlr/Zettlr) that swaps its math
rendering engine for MathJax and adds user-configurable TeX macros shared
between the editor and Pandoc export.

Everything not described here is unchanged from upstream Zettlr. For
installation, features, and general use, see the
[Zettlr repository](https://github.com/Zettlr/Zettlr) and
[documentation](https://docs.zettlr.com/); to build, follow the upstream
[development guide](https://github.com/Zettlr/Zettlr#building-from-source).

## What's different from Zettlr

- **MathJax instead of KaTeX.** Math is rendered with MathJax (CommonHTML),
  bundled locally with no CDN dependency, including
...
The build is identical to upstream Zettlr. A `justfile` wraps the common tasks:
...
[GNU GPL v3-License](https://www.gnu.org/licenses/gpl-3.0.en.html), as is
upstream Zettlr.

The Zettlr brand (including name, icons, and everything Zettlr can be identified
with) is excluded and all rights reserved.
