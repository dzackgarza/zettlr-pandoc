...
for (let i = 1, name; name = Type[i]; i++) {
    nodeTypes[i] = common.NodeType.define({
        ...
        props: i == Type.ATXHeading
            ? [[common.NodeProp.group, ["Block", "LeafBlock", "Heading"]]]
            : i >= Type.Escape
                ? []
                : [[common.NodeProp.group, i in DefaultSkipMarkup ? ["Block", "BlockContext"] : ["Block", "LeafBlock"]]],
        top: name == "Document"
    });
}
const none = [];
...
const markdownHighlighting = highlight.styleTags({
    ...
    "SetextHeading1/...": highlight.tags.heading1,
    "SetextHeading2/...": highlight.tags.heading2,
    "ATXHeading/...": highlight.tags.heading,
...
const pandocNodes = {
    defineNodes: [
        ...
        'RawInline',
        'RawInlineContent',
        { name: 'Strikethrough', style: { 'Strikethrough/...': highlight.tags.strikethrough } },
        { name: 'StrikethroughMark', style: highlight.tags.processingInstruction },
        { name: 'Table', block: true },
        'TableHeader',
        'TableRow',
        'TableCell',
...
exports.rawLatexBlockSequenceEndAtStart = rawLatexBlockSequenceEndAtStart;
