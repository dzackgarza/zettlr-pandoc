...
const updatesIntro = trans(
  "Zettlr will from time to time check for updates. If you installed Zettlr via a package manager (e.g., APT or Pacman, Homebrew, or winget or chocolatey), you should turn this off.",
);
const updatesLabel = trans("Check for Updates");
const betasIntro = trans(
  "From time to time, we also release beta updates. The more users test these early versions, the better the app becomes.",
);
