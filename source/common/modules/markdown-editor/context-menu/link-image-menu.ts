...
export function linkImageMenu(
  ...
  const isFileLink =
    validAbsoluteURI.startsWith("safe-file://") || validAbsoluteURI.startsWith("file://");
  ...
  const imgTpl: AnyMenuItem[] = [
    ...
    {
      label:
        process.platform === "darwin" ? trans("Reveal in Finder") : trans("Open in File Browser"),
      enabled: isFileLink,
      type: "normal",
      action() {
