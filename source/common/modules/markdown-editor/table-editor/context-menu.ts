...
export function displayTableContextMenu(
  event: MouseEvent,
  mainView: EditorView,
  ...
  const template: AnyMenuItem[] = [
    ...
    },
    {
      ...
      type: "normal",
      action() {
        selectAllCommand(subviewOrView);
      },
    },
    {
      type: "separator",
