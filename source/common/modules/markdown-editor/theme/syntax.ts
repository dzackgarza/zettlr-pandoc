...
const customTagHighlight = HighlightStyle.define([
  ...
  { tag: customTags.ZknLink, class: "cm-zkn-link" },
  { tag: customTags.ZknLinkTitle, class: "cm-zkn-link-title" },
  { tag: customTags.ZknLinkMark, class: "cm-zkn-link-mark cm-code-mark" },
  { tag: customTags.ZknLinkPipe, class: "cm-zkn-link-pipe cm-code-mark" },
  { tag: customTags.ZknTag, class: "cm-zkn-tag" },
  { tag: customTags.ZknTagMark, class: "cm-zkn-tag-mark cm-code-mark" },
  ...
  { tag: customTags.PandocDivInfo, class: "cm-pandoc-div-info cm-code-mark" },
  { tag: customTags.PandocDivMark, class: "cm-pandoc-div-mark cm-code-mark" },
  ...
  { tag: customTags.TableRow, class: "cm-pipe-table-row " },
...
const tagHighlight = HighlightStyle.define([
  ...
  { tag: tags.labelName, class: "cm-info-string cm-label-name" }, // CodeInfo (info string)
  { tag: tags.lineComment, class: "cm-line-comment" },
...
export function codeSyntaxHighlighter(): Extension {
  return syntaxHighlighting(tagHighlight);
}
