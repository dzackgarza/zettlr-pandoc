...
export default function registerThemes(): void {
  ...
  ipcRenderer.on(
    "css-provider",
    (evt, { command, payload }: { command: "get-custom-css-path"; payload: string }) => {
  ...
  ipcRenderer
    .invoke("css-provider", { command: "get-custom-css-path" })
...
function setSystemCss(): void {
  ...
  ipcRenderer
    .invoke("appearance-provider", { command: "get-accent-color" })
