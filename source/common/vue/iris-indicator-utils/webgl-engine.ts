...
export class WebGLEngine {
  ...
  textureSize(): { cWidth: number; cHeight: number } {
    ...
    const height =
      gl.canvas instanceof HTMLCanvasElement ? gl.canvas.clientHeight : gl.canvas.height;
