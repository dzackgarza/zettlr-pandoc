...
import { type BuiltInColor, IrisIndicator, type Vec4 } from "./iris-indicator-utils/iris-indicator";
import ButtonControl, {
  type ToolbarButtonControl,
} from "./window/toolbar-controls/ButtonControl.vue";
