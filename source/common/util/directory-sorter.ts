...
export function getSorter(
  ...
  return function sort<T extends RequiredSortingProps>(
    arr: T[],
    type: SortMethod = "name-up",
  ): T[] {
    ...
    const sortingFunc = useNatural
      ? getNaturalSorter(fileNameDisplay, appLang)
      : getAsciiSorter(fileNameDisplay);
