...
export function getGeneralFields(appLangOptions: Record<string, string>): PreferencesFieldset[] {
  ...
  const updatesDisabledSetting: PreferencesFieldset = {
    ...
    group: PreferencesGroups.General,
    infoString: trans(
      "Updates for this binary of Zettlr have been disabled at build time. This is a choice made by the packager and is common when Zettlr is being distributed via package managers. In these cases, Zettlr will be updated through your package manager.",
    ),
    fields: [],
  };
  ...
  return [
    ...
    },
    {
      ...
      infoString: trans(
        'Automatically suggests this folder to save images to, and searches this folder to propose "other files".',
      ),
      group: PreferencesGroups.General,
      help: undefined, // TODO
      fields: [
        ...
        },
        {
          ...
          display: "info",
          contents: trans(
            'Click "Select folder…" or type an absolute or relative path directly into the input field.',
          ),
        },
      ],
    },
