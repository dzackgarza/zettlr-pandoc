  ...
  return [
    {
      ...
      infoString: trans(
        "Specify how Zettlr generates new file IDs for your Zettelkasten, and enable Zettlr to detect them.",
      ),
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          display: "info",
          contents: trans(
            "Internal links allow you to add an optional title, separated by a vertical bar character from the actual link target. Here you can define the ordering of the two.",
          ),
        },
        {
          type: "radio",
    ...
    },
    {
      ...
      infoString: trans(
        "Choosing a Zettelkasten folder allows Zettlr to automatically create files when following links to not-yet-existing files. This folder must be open as a Workspace in Zettlr.",
      ),
      group: PreferencesGroups.Zettelkasten,
      fields: [
        {
