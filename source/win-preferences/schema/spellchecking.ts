  ...
  return [
    {
      ...
      infoString: trans(
        "The spellchecker checks your words for misspellings. It uses Hunspell-compatible dictionaries.",
      ),
    ...
    },
    {
      ...
      infoString: trans(
        "You can install new Hunspell-compatible dictionaries by placing them in the dictionary folder. Click the button below to open the dictionary folder. For more information, please see the manual.",
      ),
      group: PreferencesGroups.Spellchecking,
      fields: [
        {
    ...
    },
    {
      ...
      infoString: trans(
        "LanguageTool can check your texts for typos, grammatical, and stylistic issues. By default, LanguageTool sends your texts to the official servers. You can also self-host the software.",
      ),
      group: PreferencesGroups.Spellchecking,
      titleField: {
        type: "switch",
      ...
      fields: [
        ...
        },
        {
          ...
          display: "info",
          contents: trans(
            "LanguageTool cannot distinguish certain language's variants. These settings will nudge LanguageTool to auto-detect your preferred variant of these languages.",
          ),
        },
        {
          type: "select",
        ...
        },
        {
          ...
          options: {
            ...
            "ca-ES-valencia":
              resolveLangCode("ca-ES-valencia", "flag") + " " + resolveLangCode("ca-ES-valencia"),
          },
        },
        { type: "separator" },
        {
        ...
        },
        {
          ...
          display: "info",
          contents: trans(
            'Zettlr will ignore the "LanguageTool provider" settings if you enter any credentials here.',
          ),
        },
        {
          type: "text",
          ...
          disabled:
            !config.editor.lint.languageTool.active ||
            config.editor.lint.languageTool.provider === "custom",
        },
        {
          type: "text",
    ...
    },
    {
      ...
      infoString: trans(
        "These are LanguageTool rules that you have disabled. You can re-enable them here.",
      ),
      group: PreferencesGroups.Spellchecking,
      help: undefined, // TODO
      fields: [
