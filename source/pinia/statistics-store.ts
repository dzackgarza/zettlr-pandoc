...
import { avgAny30Days, last30EntriesByDate, sumAny30Days } from "source/common/util/stats";
...
export const useStatisticsStore = defineStore("statistics", () => {
  ...
  // Initial update
  ipcRenderer
    .invoke("stats-provider", { command: "get-data" })
    .then((data) => {
      stats.value = data;
    })
  ...
  return {
    ...
    sum30DaysChars,
    sum30DaysWords,
    wordsLast30CalendarDays,
    charsLast30CalendarDays,
    todayWords,
    todayChars,
  };
});
